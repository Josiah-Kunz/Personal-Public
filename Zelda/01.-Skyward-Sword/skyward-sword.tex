...
\newpage
{\huge{Hardware}}
\graphic{filename=Misc/hardware, caption={Hardware: Wii 25th anniversary dual-disc edition on a Wii U with a small child who was there for 100\% of this run. I know Skyward Sword came out for the Wii, not the Wii~U, but I first played it on a Wii~U in my youth.}}
...
\graphic{filename=Boss-Times/12-wins, caption={12 wins in a row, which can only be done in Hero Mode. This took me forever and is primarily the reason the game took 1.5 years in the first place. Incredibly difficult for me. I ended up practicing Demise without taking damage, then starting the run on Horde Battle (which is still the hardest fight). I ended this run with only 2/17 hearts.}}
...
\graphic{filename=Boss-Times/the-imprisoned-1, caption={First round of The Imprisoned record: 1:26.26}}

\graphic{filename=Boss-Times/the-imprisoned-2, caption={Second round of The Imprisoned record: 2:16.06}}
...
\graphic{filename=Boss-Times/ghirahim-1, caption={First round of Ghirahim record: 0:38.03.}}
...
\graphic{filename=Boss-Times/demise, caption={Ol' Dum Eyes record: 1:35.06. You can definitely do it quicker. For example, you can get the first stagger at 6 seconds.}}
