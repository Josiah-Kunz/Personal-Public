...
\todo{I've done this, but I used them for upgrades first. Get another screenshot when playing through hero mode!}
...
\todo{haven't gotten all of these yet!}
...
\graphic{filename=misc/lanayru-silver-1, caption={In Lanayru Desert, just as you enter the Sand Sea there are two silver rupees on top the big statue's head. They are ``out of bounds'', so the beetle starts flashing immediately. It was really tough to get these!}}

\graphic{filename=misc/lanayru-silver-2, caption={I should mention that I didn't find these all on my own. I was looking for the last heart piece and I had my dowsing set to rupees (since I was looking for a crack in the wall). Still tough!}}
