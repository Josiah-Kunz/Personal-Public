const skyURLs = [
	...
	"https://raw.githubusercontent.com/Josiah-Kunz/Personal-Public/862b34c3916b73c68f6b67e3c56aacf440d4fa92/SkyRenderer/SkyRenderer.js",
];
	...
	if (game.map.id != game.map.__skyCachedId) {
		...
		Promise.all(skyURLs.map(url => 
			...
			game.skyRenderer = new SkyRenderer(game, {
				offset: { x: 1024, y: 0 },
				resolution: { width: 1456, height: 1072 }
			});
		});
